...
local=/
file=openbh-5.1.010.rel-sf8008-eb8fd3f2_mmc.zip
cd $bb1/ImagesUpload
...
cp -rf /media/hdd1/NEOVIP/NeoBoot  $extfolder $dev_null
cp -rf /media/hdd1/NEOVIP/NeoReboot  $extfolder $dev_null
cp -rf /media/hdd1/NEOVIP/periodon $bb1/ImageBoot/$image/usr/lib/
cp -rf /media/hdd1/NEOVIP/Testinout.py  $bb1/ImageBoot/$image/usr/lib/enigma2/python/Tools/
cp -rf /media/hdd1/script_install $extfolder $dev_null
