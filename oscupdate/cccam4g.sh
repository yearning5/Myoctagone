...
curl -d "Username=$(<freeservrb70)&Password=$(<freeservrb71)&submit=addf&addf=5 Days Free Cline" -X POST "https://www.cccam4g.com/freecccam.php" > $FreeServertmpa71 
